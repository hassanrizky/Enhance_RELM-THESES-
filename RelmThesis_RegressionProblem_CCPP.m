%% Algoritma proposed untuk nilai C part 2 (CCPP Dataset)

X = data(:, 1:4);
Y = data(:, 5);

rng(82)
index00 = randperm(9568);

trainIndex = index00(1:6000);
validationIndex = index00(6001:7000);
testIndex = index00(7001:9568);
