%% Algoritma proposed untuk nilai C part 2 (Datawine
% Dataset)
...
rng(50)
index00 = randperm(4898);

trainIndex = index00(1:3000);
validationIndex = index00(3001:3500);
testIndex = index00(3501:4898);
