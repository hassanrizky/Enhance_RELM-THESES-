%% Algoritma proposed untuk nilai C part 2 (RealEstate
% Dataset)
...
rng(150)
index00 = randperm(557);

trainIndex = index00(1:300);
validationIndex = index00(301:350);
testIndex = index00(351:557);
